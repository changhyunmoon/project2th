...
import static com.team6.backend.global.exception.GlobalExceptionCode.INVALID_INPUT;
import static com.team6.backend.global.exception.GlobalExceptionCode.SERVER_ERROR;
...
public class GlobalExcpetionHandler extends ResponseEntityExceptionHandler {
    ...
    //직접 만든 CustomException 호출. 비즈니스 로직 에러등을 처리
